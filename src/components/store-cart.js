                      ...
                      <div class="flex justify-between">
                        <h3 class="text-sm">
                          <a
                            href="#"
                            class="font-medium text-gray-700 hover:text-gray-800"
                            >Polera Hombre Negra</a
                          >
                        </h3>
                      </div>
                      <div class="mt-1 flex text-sm">
                        <p class="text-gray-500">Negro</p>
          ...
          >
            ...
            <dl class="mt-6 space-y-4">
              <div class="flex items-center justify-between">
                ...
                <dd class="text-sm font-medium text-gray-900">$49.900</dd>
              </div>
              <div
              ...
              >
                ...
                <dd class="text-sm font-medium text-gray-900">$10.320</dd>
              </div>
              <div
                class="flex items-center justify-between border-t border-gray-200 pt-4"
              >
                ...
                <dd class="text-base font-medium text-gray-900">$60.220</dd>
              </div>
            </dl>
