  ...
  render() {
    return html`<div class="bg-white">
      ...
      >
        ...
        <form
          class="mt-12 lg:grid  ${this.cartItems && this.cartItems.length !== 0
            ? "lg:grid-cols-12"
            : null} lg:items-start lg:gap-x-12 xl:gap-x-16"
        >
              ...
              ? html`<div class="text-xl text-gray-600 text-center mt-24">
                  ...
                  <div class="mt-3 flex items-center justify-center">
                    <a
                      href="/"
                      type="submit"
                      class="rounded-md border border-transparent text-center bg-indigo-200 px-4 py-1 text-base font-medium text-indigo-600 shadow-sm hover:bg-indigo-300"
                    >
                      Continuar comprando
                    </a>
                  </div>`
              ...
              >
                ...
                <div class="mt-3">
                  <a
                    href="/"
                    type="submit"
                    class="w-full rounded-md border border-transparent text-center bg-indigo-200 px-4 py-3 text-base font-medium text-indigo-600 shadow-sm hover:bg-indigo-300"
                  >
                    Continuar comprando
                  </a>
                </div>
