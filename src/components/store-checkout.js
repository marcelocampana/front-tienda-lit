            ...
            <div>
              <div>
                ...
                <button
                  ...
                  class="mt-3 text-xs text-indigo-800 font-semibold"
                >
                  Iniciar sesión
                </button>
                <button
                  type="button"
                  @click=${() => (this.showModal = true)}
                  class="ml-5 mt-3 text-xs text-indigo-800 font-semibold"
                >
                  Crear cuenta
                </button>
              </div>
