      ...
      <div>
        ...
        >
          ...
          <div class="flex flex-row mt-4">
            ...
            <div class="text-2xl text-gray-500 ml-3 pt-4 ">
              Dashboard
              </div>
              </div>
                <nav class="flex flex-1 flex-col">
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                      ...
                      <ul role="list" class="-mx-2 space-y-1">
                        <li>
                          <protected-link
                            text="Productos"
                            href="/dashboard/product-list"
                            class="bg-gray-800 text-white group flex gap-x-3 rounded-md p-1 text-sm leading-6 font-semibold"
                          >
                            <svg
                              class="h-6 w-6 shrink-0 m-1"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke-width="1.5"
                              stroke="currentColor"
                        ...
                        <li>
                          ...
                          >
                            <svg
                              class="h-6 w-6 shrink-0 mt-1 ml-1"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke-width="1.5"
                              stroke="currentColor"
                    ...
                    <li class="-mx-6 mt-auto">
                      ...
                      >
                        ...
                        <div class="">
                          <div aria-hidden="true">${this.userName}</div>
                          <div aria-hidden="true" class="-mt-2">
                            <button
                              class="text-xs"
                              @click=${() => this.logout()}
                            >
